...
namespace Nez.UI
{
    ...
    public class TextField :Element, IInputListener, IKeyboardListener
    {
        ...
        static protected char ENTER_DESKTOP = '\r';
        static protected char ENTER_ANDROID = '\n';
        ...
        void paste(string content,bool fireChangeEvent)
        {
            ...
            for (int i = 0, n = content.Length; i < n; i++)
            {
                ...
                var c = content[i];
                if (!(writeEnters && (c == TextField.ENTER_DESKTOP || c == TextField.ENTER_ANDROID)))
                {
                    if (c == TextField.ENTER_DESKTOP || c == TextField.ENTER_ANDROID)
                        continue;
